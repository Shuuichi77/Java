...
10/ Ctrl + Shift + G : Indique où se trouve la variable dans tout le contenu du code

11/ Ctrl + Shift + O : Il ne se passe rien : 0 imports added

12/ Ctrl + Shift + C : Commente la ligne de code sur laquelle on se trouve (commentaire sur 1 ligne avec //)
*/
